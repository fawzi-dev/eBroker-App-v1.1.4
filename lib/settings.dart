...
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'Empire Kurd';
  static const String androidPackageName = 'com.empire.kurd';
  ...
  ///API Setting
  static const String hostUrl = "https://empirekurd.com/";
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  static const String shareNavigationWebUrl = "empire.kurd.me";
